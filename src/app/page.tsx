...
export default function Home() {
  return (
    <main>
      ...
      <div className="sw-hero">
        ...
        <div className="sw-hero-content">
          ...
          <div className="sw-hero-actions sw-animate-fade-in sw-animate-delay-3">
            <a href="#order" className="sw-btn sw-btn-primary sw-btn-lg">Order Online Here!</a>
            <a href="#menu" className="sw-btn sw-btn-outline sw-btn-lg">View Menu</a>
          </div>
        </div>
      </div>
        ...
        <div className="sw-menu-grid">
          ...
          <div className="sw-menu-card sw-animate-fade-in sw-animate-delay-1">
            ...
            <div className="sw-card-content">
              ...
              <button className="sw-btn sw-btn-primary">Add to Order</button>
            </div>
          </div>
          ...
          <div className="sw-menu-card sw-animate-fade-in sw-animate-delay-3">
            ...
            <div className="sw-card-content">
              <div className="sw-card-header">
                <h3 className="sw-item-title">Americano (12oz - 24oz)</h3>
                <span className="sw-item-price">$3.00 - $4.50</span>
              </div>
      ...
      {/* Coffee Menu Section */}
      <div className="smash-waffle-container" style={{ marginTop: '4rem' }}>
        <div className="sw-location-header">
          <h2 style={{ marginBottom: '0.5rem' }}>Coffee & Refreshments</h2>
